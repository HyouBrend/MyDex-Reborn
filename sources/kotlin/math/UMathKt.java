...
public final class UMathKt {
    ...
    private static final int m1555minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1537minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1556mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1545minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1553maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1525maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1554maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1533maxOfeb3DHEI(j, j2);
    }
}
