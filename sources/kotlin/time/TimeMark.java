...
public interface TimeMark {
    ...
    TimeMark mo1647minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1649plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1794plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1793minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1649plusLRDsOJo(Duration.m1709unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1690isNegativeimpl(timeMark.mo1646elapsedNowUwyO8pc());
        }
