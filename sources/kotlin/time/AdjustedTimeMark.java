...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1647minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1793minusLRDsOJo(this, j);
    }
    ...
    public long mo1646elapsedNowUwyO8pc() {
        return Duration.m1692minusLRDsOJo(this.mark.mo1646elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1649plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1693plusLRDsOJo(this.adjustment, duration), null);
    }
}
