...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1551getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m505constructorimpl = ((int) ULong.m505constructorimpl(j ^ ULong.m505constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m505constructorimpl2 = (m505constructorimpl + ((int) ULong.m505constructorimpl(j2 ^ ULong.m505constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m505constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m551toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m551toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1577fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
