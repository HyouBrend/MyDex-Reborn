...
public class SMTPClient extends SMTP {
    ...
    public boolean setSender(String str) throws IOException {
        return SMTPReply.isPositiveCompletion(mail(SimpleComparison.LESS_THAN_OPERATION + str + SimpleComparison.GREATER_THAN_OPERATION));
    }
    ...
    public boolean addRecipient(String str) throws IOException {
        return SMTPReply.isPositiveCompletion(rcpt(SimpleComparison.LESS_THAN_OPERATION + str + SimpleComparison.GREATER_THAN_OPERATION));
    }
