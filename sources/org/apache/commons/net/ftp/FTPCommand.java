...
public final class FTPCommand {
    ...
    private static final int LAST = 37;
    ...
    private static final String[] _commands = {"USER", "PASS", "ACCT", "CWD", "CDUP", "SMNT", "REIN", "QUIT", "PORT", "PASV", "TYPE", "STRU", "MODE", "RETR", "STOR", "STOU", "APPE", "ALLO", "REST", "RNFR", "RNTO", "ABOR", "DELE", "RMD", "MKD", "PWD", "LIST", "NLST", "SITE", "SYST", "STAT", "HELP", "NOOP", "MDTM", "FEAT", "MFMT", "EPSV", "EPRT"};
    ...
    static void checkArray() {
        ...
        throw new RuntimeException("Incorrect _commands array. Should have length 38 found " + strArr.length);
    }
