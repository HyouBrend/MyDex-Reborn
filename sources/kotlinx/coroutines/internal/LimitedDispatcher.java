...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1884scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1884scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo1883dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo1883dispatch(this, this);
    }
