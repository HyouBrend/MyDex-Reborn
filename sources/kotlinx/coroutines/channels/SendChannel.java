...
public interface SendChannel<E> {
    ...
    Object mo1838trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1838trySendJP2dKIU = sendChannel.mo1838trySendJP2dKIU(e);
            if (ChannelResult.m1853isSuccessimpl(mo1838trySendJP2dKIU)) {
                return true;
            }
            Throwable m1847exceptionOrNullimpl = ChannelResult.m1847exceptionOrNullimpl(mo1838trySendJP2dKIU);
