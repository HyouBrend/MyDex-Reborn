...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m331constructorimpl = Result.m331constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m331constructorimpl = Result.m331constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m337isFailureimpl(m331constructorimpl) ? null : m331constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1860installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1860installSignalHandler$lambda1(Signal signal) {
