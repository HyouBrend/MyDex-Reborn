...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1861catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1868catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1862debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m1864debounceHG0u8IE(flow, j);
    }
    ...
    public static final <T> Flow<T> m1863sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m1865sampleHG0u8IE(flow, j);
    }
