...
public class ZipEngine {
    ...
    */
    public void initAddFiles(java.util.ArrayList r9, net.lingala.zip4j.model.ZipParameters r10, net.lingala.zip4j.progress.ProgressMonitor r11) throws net.lingala.zip4j.exception.ZipException {
        /*
    ...
    public void addFolderToZip(File file, ZipParameters zipParameters, ProgressMonitor progressMonitor, boolean z) throws ZipException {
        ...
        addFiles(Zip4jUtil.getFilesInDirectoryRec(file, zipParameters.isReadHiddenFiles()), zipParameters, progressMonitor, z);
    }
    ...
    private void checkParameters(ZipParameters zipParameters) throws ZipException {
        ...
        if (zipParameters.isEncryptFiles()) {
            ...
            if (!Zip4jUtil.isStringNotNullAndNotEmpty(zipParameters.getPassword())) {
