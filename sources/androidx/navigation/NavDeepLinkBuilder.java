...
public final class NavDeepLinkBuilder {
    ...
    public final NavDeepLinkBuilder addDestination(String r4, Bundle args) {
        Intrinsics.checkNotNullParameter(r4, "route");
        this.destinations.add(new DeepLinkDestination(NavDestination.INSTANCE.createRoute(r4).hashCode(), args));
        if (this.graph != null) {
            verifyAllDestinations();
        }
        return this;
