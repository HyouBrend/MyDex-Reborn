...
public final class NavGraphViewModelLazyKt {
    ...
    public static final NavBackStackEntry m67navGraphViewModels$lambda0(Lazy<NavBackStackEntry> lazy) {
    ...
    public static final NavBackStackEntry m68navGraphViewModels$lambda1(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m69navGraphViewModels$lambda2(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m70navGraphViewModels$lambda3(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
}
