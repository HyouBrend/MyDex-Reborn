...
public final class FoldingFeatureObserver {
    ...
    public final void registerLayoutStateChangeCallback(Activity activity) {
        ...
        this.job = BuildersKt.launch$default(CoroutineScopeKt.CoroutineScope(ExecutorsKt.from(this.executor)), null, null, new FoldingFeatureObserver$registerLayoutStateChangeCallback$1(this, activity, null), 3, null);
    }
