...
public final /* data */ class WorkSpec {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((((((((((((((((((hashCode + (str == null ? 0 : str.hashCode())) * 31) + this.input.hashCode()) * 31) + this.output.hashCode()) * 31) + WorkSpec$$ExternalSyntheticBackport0.m(this.initialDelay)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m(this.intervalDuration)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m(this.flexDuration)) * 31) + this.constraints.hashCode()) * 31) + this.runAttemptCount) * 31) + this.backoffPolicy.hashCode()) * 31) + WorkSpec$$ExternalSyntheticBackport0.m(this.backoffDelayDuration)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m(this.lastEnqueueTime)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m(this.minimumRetentionDuration)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m(this.scheduleRequestedAt)) * 31;
