...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    public RequestManager get(FragmentActivity fragmentActivity) {
        ...
        if (useLifecycleInsteadOfInjectingFragments()) {
            ...
            return this.lifecycleRequestManagerRetriever.getOrCreate(applicationContext, Glide.get(applicationContext), fragmentActivity.getLifecycle(), fragmentActivity.getSupportFragmentManager(), isActivityVisible);
        }
        return supportFragmentGet(fragmentActivity, supportFragmentManager, null, isActivityVisible);
    }
