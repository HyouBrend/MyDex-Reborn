...
public final class zzno {
    ...
    */
    public zzno(java.lang.String r10, char[] r11) {
        /*
            r9 = this;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* bridge */ /* synthetic */ char[] zzc(zzno zznoVar) {
        return zznoVar.zzf;
    }
    ...
    public final boolean equals(@CheckForNull Object obj) {
        if (obj instanceof zzno) {
            ...
            boolean z = zznoVar.zzh;
            if (Arrays.equals(this.zzf, zznoVar.zzf)) {
                return true;
            }
        }
        return false;
    ...
    private zzno(String str, char[] cArr, byte[] bArr, boolean z) {
        this.zze = str;
        cArr.getClass();
        this.zzf = cArr;
        try {
            int length = cArr.length;
            int zzb = zzady.zzb(length, RoundingMode.UNNECESSARY);
            this.zzb = zzb;
            ...
            for (int i2 = 0; i2 < this.zzd; i2++) {
                zArr[zzady.zza(i2 * 8, this.zzb, RoundingMode.CEILING)] = true;
            }
            this.zzh = false;
