...
final class zzla extends zzkk {
    static final zzkk zza = new zzla(null, new Object[0], 0);
    ...
    private zzla(@CheckForNull Object obj, Object[] objArr, int i) {
        this.zzc = obj;
        this.zzb = objArr;
        this.zzd = i;
    }
    ...
    public static zzla zzf(int i, Object[] objArr, zzkj zzkjVar) {
        short[] sArr;
        Object[] objArr2;
        int i2 = i;
        ...
        if (i2 == 1) {
            ...
            obj3.getClass();
            zzjw.zza(obj2, obj3);
            return new zzla(null, objArr3, 1);
        }
        zzjp.zzb(i2, objArr3.length >> 1, "index");
        char c = 2;
        ...
        if (max < 751619276) {
            ...
            zzjp.zze(max < 1073741824, "collection too large");
        }
        if (i2 == 1) {
            ...
            if (i3 <= 128) {
                ...
                for (int i6 = 0; i6 < i2; i6++) {
                    ...
                    obj7.getClass();
                    zzjw.zza(obj6, obj7);
                    int zza2 = zzkd.zza(obj6.hashCode());
                    while (true) {
                        int i9 = zza2 & i4;
                        ...
                        if (i10 != 255) {
                            if (obj6.equals(objArr3[i10])) {
                                ...
                                obj8.getClass();
                                zzki zzkiVar = new zzki(obj6, obj7, obj8);
                                objArr3[i11] = obj7;
                                obj = zzkiVar;
                                break;
                            }
                ...
                for (int i13 = 0; i13 < i2; i13++) {
                    ...
                    obj10.getClass();
                    zzjw.zza(obj9, obj10);
                    int zza3 = zzkd.zza(obj9.hashCode());
                    while (true) {
                        int i16 = zza3 & i4;
                        ...
                        if (c3 != 65535) {
                            if (obj9.equals(objArr3[c3])) {
                                ...
                                obj11.getClass();
                                zzki zzkiVar2 = new zzki(obj9, obj10, obj11);
                                objArr3[i17] = obj10;
                                obj = zzkiVar2;
                                break;
                            }
                ...
                while (i18 < i2) {
                    ...
                    obj13.getClass();
                    zzjw.zza(obj12, obj13);
                    int zza4 = zzkd.zza(obj12.hashCode());
                    while (true) {
                        int i22 = zza4 & i4;
                        ?? r15 = sArr[i22];
                        if (r15 != c2) {
                            if (obj12.equals(objArr3[r15])) {
                                ...
                                obj14.getClass();
                                zzki zzkiVar3 = new zzki(obj12, obj13, obj14);
                                objArr3[i23] = obj13;
                                obj = zzkiVar3;
                                break;
                            }
        ...
        return new zzla(obj15, objArr3, i2);
    }

    /* JADX WARN: Removed duplicated region for block: B:5:0x009e A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:7:0x009f A[RETURN] */
    @Override // com.google.android.libraries.places.internal.zzkk, java.util.Map
    ...
    */
    ...
    @Override // com.google.android.libraries.places.internal.zzkk
    final zzke zza() {
