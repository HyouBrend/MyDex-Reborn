...
public class FontAssetManager {
    ...
    private Typeface getFontFamily(Font font) {
        ...
        if (fontAssetDelegate != null && (typeface2 = fontAssetDelegate.fetchFont(family, style, name)) == null) {
            typeface2 = this.delegate.fetchFont(family);
        }
        ...
        if (typeface2 == null) {
            typeface2 = Typeface.createFromAsset(this.assetManager, "fonts/" + family + this.defaultFontFileExtension);
        }
        this.fontFamilies.put(family, typeface2);
        return typeface2;
    }
